...
(function(){
  ...
  function css(){
    ...
    s=document.createElement('style');s.id=STYLE_ID;s.textContent=`
      ...
      #coach-main.dcc-ca .dcc-client-compact-top .dcc-ca-goal{margin:3px 0 0!important;padding:0!important;font-size:12px!important;line-height:1.1!important;min-height:0!important;height:auto!important}
      #coach-main.dcc-ca .dcc-client-compact-actions{
        ...
        margin:0!important;padding:0!important;min-height:32px!important;height:32px!important;max-height:32px!important;flex-wrap:nowrap!important
      }
      ...
      #coach-main.dcc-ca .dcc-client-compact-top + .dcc-ca-metrics{margin:0!important;padding:0!important}
  ...
  function apply(){
    ...
    if(head.parentElement!==top)top.prepend(head);
    ...
    if(isSummary(root)){
      ...
      if(edit||del){
        if(!actions){actions=document.createElement('div');actions.className='dcc-client-compact-actions'}
        if(actions.parentElement!==top)top.appendChild(actions);
