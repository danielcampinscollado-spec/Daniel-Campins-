...
(function(){
  'use strict';
  const BUILD='20260914-client-header-compact-v2';
  ...
  function css(){
    ...
    s=document.createElement('style');s.id=STYLE_ID;s.textContent=`
      /* Reglas geométricas deliberadamente neutras: se aplican igual a Light y Dark. */
      ...
      #coach-main.dcc-ca .dcc-ca-head{
        margin:0 2px 4px!important;padding:0!important;min-height:0!important;height:auto!important;
        display:block!important;position:relative!important
      }
      #coach-main.dcc-ca .dcc-ca-head h1{
        margin:0!important;padding:0!important;font-size:29px!important;line-height:1!important;
        letter-spacing:-.8px!important;min-height:0!important
      }
      ...
      #coach-main.dcc-ca .dcc-client-compact-actions{
        display:flex!important;align-items:center!important;gap:7px!important;margin:5px 2px 8px!important;
        padding:0!important;min-height:32px!important;height:auto!important;flex-wrap:nowrap!important
      }
      #coach-main.dcc-ca .dcc-client-compact-actions>button{
        ...
        padding:6px 12px!important;border-radius:999px!important;font-size:10px!important;line-height:1!important;
      ...
      @media(max-width:520px){
        ...
        #coach-main.dcc-ca .dcc-client-compact-actions{margin-bottom:7px!important}
      }
  ...
  function apply(){
    ...
    /* Evita huecos heredados entre acciones y métricas. */
    let node=actions.nextElementSibling;
    while(node&&node!==metrics){
      if(!String(node.textContent||'').trim()&&!node.children.length)node.remove();
      node=actions.nextElementSibling;
    }
  }
