...
(function(){
  'use strict';
  const BUILD='20260914-client-header-compact-v6';
  ...
  function css(){
    ...
    s=document.createElement('style');s.id=STYLE_ID;s.textContent=`
      ...
      #coach-main.dcc-ca .dcc-summary-actions-bottom{display:grid!important;grid-template-columns:1fr 1fr!important;gap:8px!important;margin:14px 0 0!important;padding-top:13px!important;border-top:1px solid rgba(177,119,18,.16)!important}
      #coach-main.dcc-ca .dcc-summary-actions-bottom>button{width:100%!important;min-height:42px!important;height:42px!important;margin:0!important;padding:8px 12px!important;border-radius:14px!important;font-size:10px!important;font-weight:800!important;box-shadow:none!important}
      ...
      @media(max-width:430px){
        ...
        #coach-main.dcc-ca .dcc-summary-actions-bottom>button{min-height:40px!important;height:40px!important;font-size:9px!important}
      }
    `;(document.head||document.documentElement).appendChild(s);
  }

  function isSummary(root){return norm(root.querySelector('.dcc-ca-tab.active')?.textContent)==='resumen'}
  function infoCard(root){return [...root.querySelectorAll('.dcc-ca-card')].find(card=>norm(card.querySelector('h2')?.textContent)==='información general')||null}
  function apply(){
  ...
  function boot(){apply();if(document.body&&!document.body.__dccClientHeaderCompactObserverV6){document.body.__dccClientHeaderCompactObserverV6=true;new MutationObserver(schedule).observe(document.body,{childList:true,subtree:true})}}
