/* DCC — editor de cliente estable: solo modal; las acciones las gobierna una única autoridad */
(function(){
  'use strict';
  const BUILD='20260915-client-profile-editor-v3-modal-only';
  if(window.__dccClientProfileEditorV3===BUILD)return;
  window.__dccClientProfileEditorV3=BUILD;
  ...
  function currentClient(explicitId){
    const id=explicitId??window.__dccClientAdminId??window.selectedClient;
  ...
  function ensureCss(){
    ...
    const s=document.createElement('style');s.id='dcc-client-profile-editor-css';s.textContent=`
      ...
      html:not(.dcc-theme-light-premium) .dcc-cpe-overlay{background:rgba(0,0,0,.58)}
      html:not(.dcc-theme-light-premium) .dcc-cpe-card{background:#101419;border-color:#7d622d;color:#f5f2ec;box-shadow:0 24px 70px rgba(0,0,0,.55)}
      html:not(.dcc-theme-light-premium) .dcc-cpe-head h2{color:#f5f2ec}html:not(.dcc-theme-light-premium) .dcc-cpe-close{background:#171b20;color:#f0c96b;border-color:#755b2a}
      html:not(.dcc-theme-light-premium) .dcc-cpe-field label{color:#aab1ba}html:not(.dcc-theme-light-premium) .dcc-cpe-field input,html:not(.dcc-theme-light-premium) .dcc-cpe-field textarea{background:#0a0e12;color:#f5f2ec;border-color:#303943}
      html:not(.dcc-theme-light-premium) .dcc-cpe-cancel{background:#15191e;color:#d8dde3;border-color:#343c45}
  ...
  function open(explicitId){
    ensureCss();const client=currentClient(explicitId);if(!client)return;const id=String(client.id);close();
