/* DCC — tema final entrenador Light Premium v3. Solo entrenador; sin observers globales. */
(function(){
  'use strict';
  if(window.__dccCoachThemePremiumGlobalV3)return;
  window.__dccCoachThemePremiumGlobalV3=true;
  const ID='dcc-coach-theme-premium-global-v3';

  function install(){
    document.getElementById('dcc-coach-theme-premium-global-v2')?.remove();
    ...
    s.textContent=`
/* =========================================================
   ENTRENADOR · LIGHT PREMIUM — CAPA ÚNICA Y ACOTADA
   ========================================================= */
...
/* Navegación entrenador: permanece grafito/dorado */
...
html.dcc-theme-light-premium body #coach #coach-nav button{
  color:#929ba6!important;background:transparent!important;border-color:transparent!important;box-shadow:none!important;
}
html.dcc-theme-light-premium body #coach #coach-nav button svg{color:#929ba6!important;stroke:currentColor!important;filter:none!important}
html.dcc-theme-light-premium body #coach #coach-nav button span{color:#929ba6!important}
html.dcc-theme-light-premium body #coach #coach-nav button.active{
  color:#f0c96b!important;
  background:linear-gradient(145deg,rgba(58,44,17,.96),rgba(22,18,11,.98))!important;
  border-color:rgba(240,201,107,.72)!important;
  box-shadow:0 0 0 2px rgba(177,119,18,.28),0 0 16px rgba(224,173,76,.20)!important;
}
html.dcc-theme-light-premium body #coach #coach-nav button.active svg,
html.dcc-theme-light-premium body #coach #coach-nav button.active span{color:#f0c96b!important;stroke:currentColor!important}
...
html.dcc-theme-light-premium body #coach #coach-main.dcc-p9-dashboard .dcc-p9-hero{
  background:radial-gradient(circle at 88% 8%,rgba(216,165,60,.10),transparent 30%),linear-gradient(120deg,#fffdf8,#f7ecd8 72%,#efe0c4)!important;
}
...
html.dcc-theme-light-premium body #coach #coach-main.dcc-p9-dashboard .dcc-p9-head-ico{
  background:#fff5dc!important;color:#a86d0d!important;border-color:rgba(185,122,17,.30)!important;
}
...
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-clients .dcc-cl-name{color:#17191d!important}
...
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-clients .dcc-cl-pct{color:#68717d!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-clients .dcc-cl-goal{color:#a46b0b!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-clients .dcc-cl-training{border-left-color:rgba(80,86,94,.24)!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-clients .dcc-cl-tr-title{color:#4d5661!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-clients .dcc-cl-dumbbell{color:#d8a53c!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-clients .dcc-cl-track{background:#293039!important}
...
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-clients .dcc-cl-sort{
  background:#fffefa!important;color:#59636f!important;border-color:rgba(185,122,17,.28)!important;box-shadow:none!important;
}
...
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-clients .dcc-cl-search input::placeholder{color:#7a8390!important;-webkit-text-fill-color:#7a8390!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-clients .dcc-cl-tab{color:#68717d!important;background:transparent!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-clients .dcc-cl-tab.active{
  background:linear-gradient(145deg,#fff1c5,#edc15a)!important;color:#1d1608!important;border-color:#d7a43a!important;box-shadow:none!important;
}
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-clients .dcc-cl-manage{
  background:#fffaf1!important;color:#8f5d0a!important;border-color:rgba(185,122,17,.50)!important;box-shadow:none!important;
}
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-clients .dcc-cl-new{
  background:linear-gradient(135deg,#f5d581,#dca83e)!important;color:#18140c!important;border-color:#e9bd55!important;
}

/* Compatibilidad con renderer de clientes final */
html.dcc-theme-light-premium body #coach #coach-main.dcc-final-clients .dcc-fcl-card{background:linear-gradient(145deg,#fffefa,#fbf6ec)!important;color:#17191d!important;border-color:rgba(198,139,32,.38)!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-final-clients .dcc-fcl-name{color:#17191d!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-final-clients .dcc-fcl-goal{color:#a46b0b!important}
...
html.dcc-theme-light-premium body #coach #coach-main.dcc-final-clients .dcc-fcl-sort{background:#fffefa!important;color:#17191d!important;border-color:rgba(185,122,17,.28)!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-final-clients .dcc-fcl-search input{color:#17191d!important;-webkit-text-fill-color:#17191d!important;background:transparent!important}
...
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-checkins .dcc-ci-empty{
  background:linear-gradient(145deg,#fffefa,#fbf6ec)!important;color:#17191d!important;border-color:rgba(198,139,32,.36)!important;box-shadow:0 9px 22px rgba(83,63,31,.06)!important;
}
...
/* =========================================================
   MENSAJES — LISTA Y CHAT V2 REAL
   ========================================================= */
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-messages .dcc-msg-card{background:linear-gradient(145deg,#fffefa,#fbf6ec)!important;color:#17191d!important;border-color:rgba(198,139,32,.36)!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-messages .dcc-msg-name{color:#17191d!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-premium-messages .dcc-msg-search{background:#fffefa!important;color:#17191d!important;border-color:rgba(185,122,17,.28)!important}

html.dcc-theme-light-premium body #coach #coach-main.dcc-message-chat-v2{
  background:radial-gradient(circle at 88% 0,rgba(214,163,61,.08),transparent 28%),linear-gradient(180deg,#fffaf1,#f5efe4)!important;
  color:#17191d!important;
}
html.dcc-theme-light-premium body #coach #coach-main.dcc-message-chat-v2 .dcc-mcv2-back{background:#fffaf1!important;color:#8f5d0a!important;border-color:rgba(185,122,17,.40)!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-message-chat-v2 .dcc-mcv2-person{border-bottom-color:rgba(58,63,69,.24)!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-message-chat-v2 .dcc-mcv2-person h1{color:#17191d!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-message-chat-v2 .dcc-mcv2-status{color:#68717d!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-message-chat-v2 .dcc-mcv2-avatar,
html.dcc-theme-light-premium body #coach #coach-main.dcc-message-chat-v2 .dcc-mcv2-mini{background:#10151b!important;color:#f0c96b!important;border-color:rgba(217,170,74,.60)!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-message-chat-v2 .dcc-mcv2-day{color:#7a8390!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-message-chat-v2 .dcc-mcv2-day:before,
html.dcc-theme-light-premium body #coach #coach-main.dcc-message-chat-v2 .dcc-mcv2-day:after{background:rgba(58,63,69,.22)!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-message-chat-v2 .dcc-mcv2-empty{
  background:linear-gradient(145deg,#fffefa,#fbf6ec)!important;color:#68717d!important;border-color:rgba(185,122,17,.28)!important;
}
html.dcc-theme-light-premium body #coach #coach-main.dcc-message-chat-v2 .dcc-mcv2-bubble{
  background:#fffefa!important;color:#17191d!important;border-color:rgba(185,122,17,.24)!important;box-shadow:0 5px 14px rgba(83,63,31,.05)!important;
}
html.dcc-theme-light-premium body #coach #coach-main.dcc-message-chat-v2 .dcc-mcv2-row.mine .dcc-mcv2-bubble{background:#fff1c9!important;color:#17191d!important;border-color:rgba(185,122,17,.40)!important}
html.dcc-theme-light-premium body #coach #coach-main.dcc-message-chat-v2 .dcc-mcv2-time{color:#7a8390!important}
html.dcc-theme-light-premium body #coach .dcc-mcv2-composer{
  background:rgba(255,250,241,.98)!important;border-color:rgba(185,122,17,.42)!important;box-shadow:0 -8px 28px rgba(83,63,31,.12)!important;
}
html.dcc-theme-light-premium body #coach .dcc-mcv2-input{
  background:#fffefa!important;color:#17191d!important;-webkit-text-fill-color:#17191d!important;border-color:rgba(128,117,99,.28)!important;
}
html.dcc-theme-light-premium body #coach .dcc-mcv2-input::placeholder{color:#7a8390!important;-webkit-text-fill-color:#7a8390!important}
...
html.dcc-theme-light-premium body #coach #coach-main.dcc-cal-v11 .dcc-cal-head h1,
html.dcc-theme-light-premium body #coach #coach-main.dcc-cal-v11 .dcc-cal-month-head strong{color:#17191d!important}
...
/* =========================================================
   FICHA CLIENTE / ADMIN ENTRENADOR
   ========================================================= */
...
html.dcc-theme-light-premium body #coach #coach-main.dcc-ca .dcc-p5-card{
  background:linear-gradient(145deg,#fffefa,#fbf6ec)!important;color:#17191d!important;border-color:rgba(198,139,32,.34)!important;
}
...
/* =========================================================
   MODAL NUEVO CLIENTE — ESTÁ FUERA DE #coach-main
   ========================================================= */
html.dcc-theme-light-premium body #modal.dcc-new-client-overlay{background:rgba(28,24,18,.45)!important}
html.dcc-theme-light-premium body #modal.dcc-new-client-overlay .modal-box{
  background:radial-gradient(circle at 92% 0,rgba(214,163,61,.08),transparent 28%),linear-gradient(145deg,#fffefa,#f8f0e2)!important;
  background-color:#fffaf1!important;color:#17191d!important;border-color:rgba(198,139,32,.55)!important;
  box-shadow:0 26px 70px rgba(47,36,18,.26),inset 0 1px 0 rgba(255,255,255,.98)!important;
}
html.dcc-theme-light-premium body #modal.dcc-new-client-overlay #dcc-new-client-premium .dcc-nc-title{
  background:none!important;-webkit-background-clip:border-box!important;background-clip:border-box!important;color:#17191d!important;-webkit-text-fill-color:#17191d!important;
}
html.dcc-theme-light-premium body #modal.dcc-new-client-overlay #dcc-new-client-premium .dcc-nc-sub{color:#9a6915!important}
html.dcc-theme-light-premium body #modal.dcc-new-client-overlay #dcc-new-client-premium .dcc-nc-label{color:#24272c!important}
html.dcc-theme-light-premium body #modal.dcc-new-client-overlay #dcc-new-client-premium .dcc-nc-label svg{color:#b77b13!important}
html.dcc-theme-light-premium body #modal.dcc-new-client-overlay #dcc-new-client-premium .dcc-nc-input,
html.dcc-theme-light-premium body #modal.dcc-new-client-overlay #dcc-new-client-premium .dcc-nc-select{
  background:#fffefa!important;color:#17191d!important;-webkit-text-fill-color:#17191d!important;border-color:rgba(139,127,107,.30)!important;box-shadow:inset 0 1px 0 #fff!important;
}
html.dcc-theme-light-premium body #modal.dcc-new-client-overlay #dcc-new-client-premium .dcc-nc-input::placeholder{color:#7a8390!important;-webkit-text-fill-color:#7a8390!important}
html.dcc-theme-light-premium body #modal.dcc-new-client-overlay #dcc-new-client-premium .dcc-nc-close{background:#171b21!important;color:#f0c96b!important;border-color:rgba(217,170,74,.55)!important}

/* =========================================================
   MODAL REVISIÓN CHECK-IN — GLOBAL
   ========================================================= */
html.dcc-theme-light-premium body .dcc-ci-modal{background:rgba(28,24,18,.46)!important}
html.dcc-theme-light-premium body .dcc-ci-modal .dcc-ci-review{
  ...
  color:#17191d!important;border-color:rgba(198,139,32,.55)!important;box-shadow:0 26px 70px rgba(47,36,18,.26)!important;
}
html.dcc-theme-light-premium body .dcc-ci-modal .dcc-ci-review-head h2{color:#17191d!important}
html.dcc-theme-light-premium body .dcc-ci-modal .dcc-ci-review-sub,
...
html.dcc-theme-light-premium body .dcc-ci-modal .dcc-ci-rvalue{color:#17191d!important}
...
html.dcc-theme-light-premium body .dcc-ci-modal .dcc-ci-close{background:#171b21!important;color:#f0c96b!important;border-color:rgba(217,170,74,.55)!important}
...
/* =========================================================
   MODAL NUEVA SESIÓN CALENDARIO — GLOBAL
   ========================================================= */
...
html.dcc-theme-light-premium body #dcc-session-standalone-overlay label{color:#17191d!important}
...
html.dcc-theme-light-premium body #dcc-session-standalone-overlay textarea{
  background:#fffefa!important;color:#17191d!important;-webkit-text-fill-color:#17191d!important;border-color:rgba(139,127,107,.30)!important;
}
html.dcc-theme-light-premium body #dcc-session-standalone-overlay .close{background:#171b21!important;color:#f0c96b!important;border-color:rgba(217,170,74,.55)!important}
