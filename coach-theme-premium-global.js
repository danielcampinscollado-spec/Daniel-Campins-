/* DCC — tema global estable para panel entrenador + navegación */
(function(){
  'use strict';
  ...
  function install(){
    ...
    s.textContent=`
/* ---------------------------------------------------------
   BASE NAV: se carga antes de entrar al cliente para evitar
   el parpadeo negro/sin estilo al crear la barra inferior.
--------------------------------------------------------- */
#client-nav,#coach-nav{
  background:linear-gradient(145deg,#28251f,#151513 58%,#222019)!important;
  border:1px solid rgba(231,181,73,.78)!important;
  box-shadow:0 12px 34px rgba(68,49,18,.26),0 0 0 1px rgba(255,211,108,.10),inset 0 1px 0 rgba(255,230,157,.10)!important;
}
...
#client-nav button.active,#coach-nav button.active{
  color:#1d1608!important;background:linear-gradient(145deg,#ffe8a4 0%,#e6af3d 72%,#c88920 100%)!important;
  border-color:#ffe39a!important;box-shadow:0 0 0 2px rgba(177,119,18,.42),0 0 18px rgba(237,187,72,.52),0 8px 20px rgba(0,0,0,.24)!important
}
...
--------------------------------------------------------- */
html:not(.dcc-theme-light-premium) body #coach{
  --dcc-gold:#d9aa4a;--dcc-gold2:#f0c96b;--dcc-border:rgba(240,201,107,.66);--dcc-border-soft:rgba(217,170,74,.30);
  --dcc-bg:radial-gradient(ellipse at 88% 3%,rgba(217,170,74,.11),transparent 25%),radial-gradient(ellipse at 7% 84%,rgba(217,170,74,.045),transparent 30%),linear-gradient(150deg,#080b0e 0%,#050709 50%,#020405 100%);
  --dcc-card:radial-gradient(circle at 92% 5%,rgba(240,201,107,.11),transparent 32%),linear-gradient(145deg,#12181d 0%,#0a0e11 60%,#070a0c 100%);
  --dcc-inner:radial-gradient(circle at 92% 5%,rgba(240,201,107,.055),transparent 34%),linear-gradient(145deg,#0f1519 0%,#090d10 72%);
  background:var(--dcc-bg)!important;color:#f6f3ed!important
}
...
html:not(.dcc-theme-light-premium) body #coach #coach-main .dcc-p9-stat,
html:not(.dcc-theme-light-premium) body #coach #coach-main .dcc-p9-hero,
html:not(.dcc-theme-light-premium) body #coach #coach-main .dcc-p9-accordion,
html:not(.dcc-theme-light-premium) body #coach #coach-main .dcc-cl-card,
html:not(.dcc-theme-light-premium) body #coach #coach-main .dcc-fcl-card,
html:not(.dcc-theme-light-premium) body #coach #coach-main .dcc-ci-card,
html:not(.dcc-theme-light-premium) body #coach #coach-main .dcc-msg-card,
html:not(.dcc-theme-light-premium) body #coach #coach-main .dcc-cal-card,
html:not(.dcc-theme-light-premium) body #coach #coach-main .dcc-ca-card,
html:not(.dcc-theme-light-premium) body #coach #coach-main .dcc-ca-metric,
html:not(.dcc-theme-light-premium) body #coach #coach-main .card{
  border-color:var(--dcc-border)!important;background:var(--dcc-card)!important;color:#f4f1ec!important
}

/* ---------------------------------------------------------
   LIGHT PREMIUM · entrenador
   Regla final y de alta especificidad para ganar a los
   estilos negros que inyectan los módulos de cada pantalla.
--------------------------------------------------------- */
...
html.dcc-theme-light-premium body #coach #coach-main.dcc-ca{
  --dcc-gold:#b77b13!important;--dcc-gold2:#d7a53f!important;
  --dcc-border:rgba(190,132,31,.42)!important;--dcc-border-soft:rgba(190,132,31,.26)!important;
  --dcc-bg-light:radial-gradient(circle at 88% 0,rgba(214,163,61,.10),transparent 26%),linear-gradient(180deg,#fffaf1 0%,#f5efe4 62%,#f1e9dc 100%)!important;
  background:var(--dcc-bg-light)!important;background-color:#f5efe4!important;color:#17191d!important
}
html.dcc-theme-light-premium body #coach #coach-main{
  min-height:100dvh!important;color:#17191d!important;
  padding-top:max(22px,env(safe-area-inset-top))!important;padding-bottom:118px!important
}
...
html.dcc-theme-light-premium body #coach #coach-main [class*="weight"]{color:#657080!important}

/* tarjetas principales de todas las pestañas */
...
html.dcc-theme-light-premium body #coach #coach-main .dcc-p5-section,
html.dcc-theme-light-premium body #coach #coach-main .dcc-p5-metric,
...
html.dcc-theme-light-premium body #coach #coach-main .metrics{
  ...
  border:1px solid rgba(198,139,32,.38)!important;color:#17191d!important;
  box-shadow:0 12px 30px rgba(83,63,31,.08),inset 0 1px 0 rgba(255,255,255,.95)!important
}
html.dcc-theme-light-premium body #coach #coach-main .dcc-ca-activity-item,
html.dcc-theme-light-premium body #coach #coach-main .dcc-p5-card,
...
html.dcc-theme-light-premium body #coach #coach-main .client-row{
  background:#fffaf1!important;color:#17191d!important;border-color:rgba(185,122,17,.24)!important
}

/* títulos/kickers */
html.dcc-theme-light-premium body #coach #coach-main .dcc-p9-kicker,
html.dcc-theme-light-premium body #coach #coach-main .dcc-cl-kicker,
...
html.dcc-theme-light-premium body #coach #coach-main [class*="eyebrow"]{
  ...
  font-size:11px!important;font-weight:800!important;letter-spacing:3px!important;text-transform:uppercase!important
}

/* buscadores, filtros y pestañas */
...
html.dcc-theme-light-premium body #coach #coach-main .dcc-chat-composer{
  background:#fffefa!important;color:#17191d!important;border-color:rgba(185,122,17,.30)!important;
  box-shadow:0 8px 22px rgba(83,63,31,.06)!important
}
...
html.dcc-theme-light-premium body #coach #coach-main select{
  background:#fffefa!important;color:#17191d!important;-webkit-text-fill-color:#17191d!important;border-color:rgba(185,122,17,.28)!important;box-shadow:none!important
}
html.dcc-theme-light-premium body #coach #coach-main .dcc-u-search>input::placeholder,
...
html.dcc-theme-light-premium body #coach #coach-main .dcc-fcl-card button,
html.dcc-theme-light-premium body #coach #coach-main .dcc-cl-card button,
html.dcc-theme-light-premium body #coach #coach-main .dcc-ci-card button,
html.dcc-theme-light-premium body #coach #coach-main .dcc-msg-card button{
  background:#fffaf1!important;color:#98640b!important;border-color:rgba(185,122,17,.42)!important
}
...
html.dcc-theme-light-premium body #coach #coach-main .dcc-p9-name{color:#17191d!important}
html.dcc-theme-light-premium body #coach #coach-main .dcc-p9-stat strong{color:#17191d!important}
...
html.dcc-theme-light-premium body #coach #coach-main .dcc-cal-head h1,
...
html.dcc-theme-light-premium body #coach #coach-main .dcc-chat-empty{background:#fffaf1!important;color:#17191d!important;border-color:rgba(185,122,17,.28)!important}
...
/* modal de revisión check-in: vive fuera de #coach */
html.dcc-theme-light-premium body .dcc-ci-review{
  background:linear-gradient(145deg,#fffefa,#f8f0e2)!important;color:#17191d!important;border:1px solid rgba(190,132,31,.56)!important;
  box-shadow:0 28px 80px rgba(83,63,31,.20)!important
}
html.dcc-theme-light-premium body .dcc-ci-review h1,
html.dcc-theme-light-premium body .dcc-ci-review h2,
html.dcc-theme-light-premium body .dcc-ci-review strong,
html.dcc-theme-light-premium body .dcc-ci-review b{color:#17191d!important}
html.dcc-theme-light-premium body .dcc-ci-review [class*="row"],
html.dcc-theme-light-premium body .dcc-ci-review [class*="metric"]{background:#fffaf1!important;color:#17191d!important;border-color:rgba(185,122,17,.24)!important}
html.dcc-theme-light-premium body .dcc-ci-review [class*="label"],
html.dcc-theme-light-premium body .dcc-ci-review p{color:#657080!important}

@media(max-width:520px){
  html.dcc-theme-light-premium body #coach #coach-main{padding-top:max(24px,env(safe-area-inset-top))!important}
  html.dcc-theme-light-premium body #coach #coach-main .dcc-cl-card,
  html.dcc-theme-light-premium body #coach #coach-main .dcc-fcl-card,
  html.dcc-theme-light-premium body #coach #coach-main .dcc-ci-card,
...
`;
  ...
  function coachVisible(){
    ...
    const st=getComputedStyle(coach);
    return st.display!=='none'&&st.visibility!=='hidden';
  }
  function syncSurface(){
    document.body?.classList.toggle('dcc-coach-surface',coachVisible());
  }
  function resetCoachScroll(){
    if(!coachVisible())return;
    try{window.scrollTo({top:0,left:0,behavior:'auto'})}catch(_){window.scrollTo(0,0)}
    const main=document.getElementById('coach-main');if(main)main.scrollTop=0;
  }
  function fixClientSearch(){
    ...
    input.style.setProperty('color',light?'#17191d':'#f4f1ed','important');
    input.style.setProperty('-webkit-text-fill-color',light?'#17191d':'#f4f1ed','important');
  ...
  document.addEventListener('click',e=>{
    if(e.target.closest('#coach-nav button'))setTimeout(()=>{syncSurface();resetCoachScroll();fixClientSearch()},0);
    if(e.target.closest('#client-nav button'))setTimeout(syncSurface,0);
  },true);
  window.addEventListener('dcc:themechange',()=>{fixClientSearch();syncSurface()});

  const roots=[document.getElementById('coach'),document.getElementById('client')].filter(Boolean);
  if(roots.length){
    const o=new MutationObserver(()=>syncSurface());
    roots.forEach(r=>o.observe(r,{attributes:true,attributeFilter:['style','class']}));
  }
})();
