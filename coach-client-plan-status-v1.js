...
(function(){
'use strict';
const BUILD='20260916-client-quality-bootstrap-v51-nav-no-vibration';
...
load('./clients-name-only-v1.js?v=20260916-8','clients-name-only');
...
load('./coach-bottom-nav-fix-v1.js?v=20260916-5','coach-bottom-nav-fix',()=>load('./bottom-nav-light-premium-v1.js?v=20260916-2','bottom-nav-light-premium'));
