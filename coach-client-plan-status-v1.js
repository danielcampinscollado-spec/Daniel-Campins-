...
(function(){
'use strict';
const BUILD='20260915-client-quality-bootstrap-v37-training-save-flow';
...
load('./training-inline-fix.js?v=20260915-restore1','training-inline-fix',()=>load('./training-coach-fixes-v1.js?v=20260915-restore1','training-coach-fixes',()=>load('./training-defaults-v1.js?v=20260915-restore1','training-defaults',()=>load('./training-day-wizard-v1.js?v=20260915-3','training-day-wizard',()=>load('./training-editor-stability-v1.js?v=20260915-2','training-editor-stability',()=>load('./training-exercise-picker-v2.js?v=20260915-3','training-exercise-picker-v2',()=>load('./training-draft-guard-v1.js?v=20260915-2','training-draft-guard',()=>load('./coach-editor-flow-v1.js?v=20260915-1','coach-editor-flow',()=>load('./training-interaction-fix-v1.js?v=20260915-1','training-interaction-fix',()=>load('./training-save-actions-position-v1.js?v=20260915-1','training-save-actions-position'))))))))));
