...
(function(){
'use strict';
const BUILD='20260916-client-quality-bootstrap-v49-compact-client-density';
...
load('./clients-name-only-v1.js?v=20260916-7','clients-name-only',()=>load('./clients-compact-density-v1.js?v=20260916-1','clients-compact-density'));
...
load('./coach-bottom-nav-fix-v1.js?v=20260916-4','coach-bottom-nav-fix',()=>load('./bottom-nav-light-premium-v1.js?v=20260916-1','bottom-nav-light-premium'));
