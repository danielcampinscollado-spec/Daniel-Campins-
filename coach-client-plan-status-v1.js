...
(function(){
'use strict';
const BUILD='20260916-client-quality-bootstrap-v50-approved-mock';
...
load('./coach-bottom-nav-fix-v1.js?v=20260916-4','coach-bottom-nav-fix',()=>load('./bottom-nav-light-premium-v1.js?v=20260916-2','bottom-nav-light-premium'));
