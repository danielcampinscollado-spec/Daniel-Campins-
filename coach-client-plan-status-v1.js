...
(function(){
'use strict';
const BUILD='20260916-client-quality-bootstrap-v47-clean-clients-nav';
...
load('./clients-name-only-v1.js?v=20260916-6','clients-name-only');
...
load('./coach-bottom-nav-fix-v1.js?v=20260916-3','coach-bottom-nav-fix',()=>load('./bottom-nav-light-premium-v1.js?v=20260916-1','bottom-nav-light-premium'));
