/* DCC — Clientes light: tarjeta limpia + fecha de alta */
(function(){
'use strict';
const BUILD='20260916-clients-reference-v6-clean';
...
function injectCss(){
  ...
  s.textContent=`
    ...
    #coach-main.dcc-premium-clients .dcc-cl-card.dcc-cl-card-ref{display:flex!important;grid-template-columns:none!important;align-items:center!important;width:100%!important;min-height:88px!important;padding:12px 14px!important;gap:12px!important;border-radius:17px!important;cursor:pointer!important;overflow:hidden!important}
    ...
    #coach-main.dcc-premium-clients .dcc-client-avatar{width:50px!important;height:50px!important;flex:0 0 50px!important;display:flex!important;align-items:center!important;justify-content:center!important;border:1px solid rgba(213,164,56,.38)!important;border-radius:50%!important;background:rgba(217,170,74,.09)!important;color:#b57b18!important}
    #coach-main.dcc-premium-clients .dcc-client-avatar svg{width:28px!important;height:28px!important;fill:none!important;stroke:currentColor!important;stroke-width:1.8!important}
    ...
    #coach-main.dcc-premium-clients .dcc-client-name-ref{min-width:0!important;margin:0!important;color:#111318!important;font-size:16px!important;font-weight:850!important;line-height:1.15!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}
    #coach-main.dcc-premium-clients .dcc-client-since{color:#7d8594!important;font-size:11px!important;font-weight:550!important;line-height:1.2!important;white-space:nowrap!important}
    #coach-main.dcc-premium-clients .dcc-manage-client-btn{flex:0 0 auto!important;width:94px!important;min-width:94px!important;height:42px!important;margin:0!important;padding:0 10px!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;border:1.4px solid #d5a438!important;border-radius:13px!important;background:rgba(255,255,255,.30)!important;color:#80530a!important;font-family:inherit!important;font-size:11.5px!important;font-weight:800!important;line-height:1!important;letter-spacing:0!important;text-transform:none!important;white-space:nowrap!important;box-shadow:none!important;cursor:pointer!important}
    ...
    @media(max-width:390px){
      #coach-main.dcc-premium-clients .dcc-cl-card.dcc-cl-card-ref{min-height:84px!important;padding:10px 12px!important;gap:9px!important}
      #coach-main.dcc-premium-clients .dcc-client-avatar{width:46px!important;height:46px!important;flex-basis:46px!important}
      #coach-main.dcc-premium-clients .dcc-client-avatar svg{width:26px!important;height:26px!important}
      ...
      #coach-main.dcc-premium-clients .dcc-manage-client-btn{width:86px!important;min-width:86px!important;height:40px!important;padding:0 8px!important;font-size:10.5px!important}
    }
  `;
...
function apply(){
  ...
  cards.forEach(card=>{
    ...
    card.querySelectorAll(':scope > .dcc-cl-chevron,:scope > .dcc-client-avatar,:scope > .dcc-client-copy,:scope > .dcc-client-name-ref,:scope > .dcc-manage-client-btn').forEach(el=>el.remove());
    ...
    const name=document.createElement('span');name.className='dcc-client-name-ref';name.textContent=oldName;copy.appendChild(name);
    ...
    const btn=document.createElement('button');btn.type='button';btn.className='dcc-manage-client-btn';btn.setAttribute('aria-label',`Gestionar ${oldName}`);btn.textContent='Gestionar';
    card.append(avatar,copy,btn);
    card.dataset.dccReferenceReady='6';
  });
}

document.addEventListener('dcc:coach-screen',e=>{if(e.detail?.screen==='clients')requestAnimationFrame(apply)});
const obs=new MutationObserver(()=>{if(document.getElementById('coach-main')?.classList.contains('dcc-premium-clients'))requestAnimationFrame(apply)});
