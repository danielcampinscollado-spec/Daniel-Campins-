...
(function(){
  ...
  function loadPremiumMuscles(){
    ...
    const s=document.createElement('script');s.src='./training-muscle-premium-light-v1.js?v=20260918-approved1';s.async=true;s.dataset.dccMusclePremium='1';(document.head||document.documentElement).appendChild(s);
  }
