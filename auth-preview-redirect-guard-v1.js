...
(function(){
  'use strict';
  const BUILD='20260914-auth-preview-redirect-v19';
  ...
  loadAuthority('./coach-edit-safety-v1.js?v=20260914-2','navigation-safety');
  ...
  loadAuthority('./coach-calendar-nav-guard-v1.js?v=20260914-1','calendar-nav-guard');
})();