...
(function(){
  'use strict';
  const BUILD='20260914-auth-preview-redirect-v25';
  ...
  loadAuthority('./client-header-compact-v1.js?v=20260914-5','client-header-compact');
  loadAuthority('./coach-calendar-nav-guard-v1.js?v=20260914-5','calendar-nav-guard');
})();
