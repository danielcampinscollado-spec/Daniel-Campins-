...
(function(){
  'use strict';
  const BUILD='20260915-auth-preview-redirect-v34-stable';
  ...
  loadAuthority('./coach-route-state-bridge-v1.js?v=20260915-3','route-state-bridge');
  loadAuthority('./coach-calendar-nav-guard-v1.js?v=20260915-12','calendar-nav-guard');
