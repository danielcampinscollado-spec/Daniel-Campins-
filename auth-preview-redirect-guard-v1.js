...
(function(){
  'use strict';
  const BUILD='20260914-auth-preview-redirect-v31';
  ...
  loadAuthority('./coach-edit-scroll-lock-v1.js?v=20260914-4','edit-scroll-lock');
  ...
  loadAuthority('./client-edit-visibility-v1.js?v=20260914-1','client-edit-visibility');
