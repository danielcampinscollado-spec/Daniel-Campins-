...
(function(){
  ...
  const MALE_VISUAL={Pectoral:'client-pectoral-premium-v5.webp',Dorsal:'client-dorsal-premium-v5.webp',Hombros:'client-hombros-premium-v5.webp',Trapecio:'client-trapecio-premium-v6.svg','Bíceps':'client-biceps-premium-v5.webp','Tríceps':'client-triceps-premium-v5.webp',Antebrazos:'client-antebrazos-premium-v6.svg',Core:'client-core-premium-v5.webp','Cuádriceps':'client-cuadriceps-premium-v5.webp',Femoral:'client-femoral-premium-v5.webp','Glúteos':'client-gluteos-premium-v5.webp',Gemelos:'client-gemelos-premium-v5.webp'};
  const FEMALE_VISUAL={Pectoral:'client-pectoral-female-premium-v3.svg',Dorsal:'client-dorsal-female-premium-v3.svg',Hombros:'client-hombros-female-premium-v3.svg',Trapecio:'client-trapecio-female-premium-v3.svg','Bíceps':'client-biceps-female-premium-v3.svg','Tríceps':'client-triceps-female-premium-v3.svg',Antebrazos:'client-antebrazos-female-premium-v3.svg',Core:'client-core-female-premium-v3.svg','Cuádriceps':'client-cuadriceps-female-premium-v3.svg',Femoral:'client-femoral-female-premium-v3.svg','Glúteos':'client-gluteos-female-premium-v3.svg',Gemelos:'client-gemelos-female-premium-v3.svg'};
  function muscleVisual(m){const female=state.anatomyDraft==='female',map=female?FEMALE_VISUAL:MALE_VISUAL;return `background-image:url('./assets/muscles/${map[m]||(female?'anatomy-female-final.svg':'anatomy-male-final.svg')}');background-size:contain;background-position:center center`}
