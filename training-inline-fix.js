...
(function(){
  ...
  const MALE_VISUAL={Pectoral:'client-pectoral-premium-v5.webp',Dorsal:'client-dorsal-premium-v5.webp',Hombros:'client-hombros-premium-v5.webp',Trapecio:'client-dorsal-premium-v5.webp','Bíceps':'client-biceps-premium-v5.webp','Tríceps':'client-triceps-premium-v5.webp',Antebrazos:'client-pectoral-premium-v5.webp',Core:'client-core-premium-v5.webp','Cuádriceps':'client-cuadriceps-premium-v5.webp',Femoral:'client-femoral-premium-v5.webp','Glúteos':'client-gluteos-premium-v5.webp',Gemelos:'client-gemelos-premium-v5.webp'};
  ...
  function muscleVisual(m){const female=state.anatomyDraft==='female',map=female?FEMALE_VISUAL:MALE_VISUAL,file=map[m]||(female?'anatomy-female-final.svg':'anatomy-male-final.svg');if(!female&&m==='Trapecio')return `background-image:linear-gradient(rgba(250,247,238,.12),rgba(250,247,238,.12)),url('./assets/muscles/${file}');background-size:contain;background-position:center -2px`;if(!female&&m==='Antebrazos')return `background-image:linear-gradient(rgba(250,247,238,.12),rgba(250,247,238,.12)),url('./assets/muscles/${file}');background-size:118% auto;background-position:center -8px`;return `background-image:url('./assets/muscles/${file}');background-size:${female?'88% auto':'contain'};background-position:center center`}
