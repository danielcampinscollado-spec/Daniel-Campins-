...
(function(){
  ...
  function muscleVisual(m){const female=state.anatomyDraft==='female',map=female?FEMALE_VISUAL:MALE_VISUAL;return `background-image:url('./assets/muscles/${map[m]||(female?'anatomy-female-final.svg':'anatomy-male-final.svg')}');background-size:${female?'82% auto':'contain'};background-position:center center`}
