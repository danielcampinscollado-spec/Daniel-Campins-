...
(function(){
  ...
  function muscleVisual(m){const female=state.anatomyDraft==='female',map=female?FEMALE_VISUAL:MALE_VISUAL,file=map[m]||(female?'anatomy-female-final.svg':'anatomy-male-final.svg');return `background-image:url('./assets/muscles/${file}');background-size:${female?'80% auto':'contain'};background-position:center center`}
