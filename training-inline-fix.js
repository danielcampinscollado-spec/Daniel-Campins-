...
(function(){
  ...
  function muscleVisual(m){if(state.anatomyDraft==='female'){if(FEMALE_SPECIAL[m])return `background-image:url('./assets/muscles/${FEMALE_SPECIAL[m]}');background-size:contain;background-position:center`;return `background-image:url('./assets/muscles/anatomy-female-premium-v1.webp');background-size:300% auto;background-position:${FEMALE_POS[m]||'center'}`}return `background-image:url('./assets/muscles/${MALE_VISUAL[m]||'anatomy-male-final.svg'}')`}
