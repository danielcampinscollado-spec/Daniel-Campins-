...
(function(){
  ...
  function ensureCss(){
    ...
    const s=document.createElement('style');s.id='dcc-training-inline-fix-css';s.textContent=`
      ...
      .dcc-tr-actions{grid-template-columns:minmax(0,1fr) minmax(0,1fr)!important;align-items:stretch!important}.dcc-tr-actions>.dcc-tr-edit,.dcc-tr-actions>.dcc-tr-new,.dcc-tr-actions>.dcc-tr-history-panel{min-width:0!important;width:100%!important;box-sizing:border-box!important;margin:0!important}.dcc-tr-history-panel{margin-top:0;border:1px solid rgba(183,123,19,.25);border-radius:16px;background:#fffdf8;overflow:hidden}.dcc-tr-history-head{width:100%;display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;padding:13px 14px;border:0;background:transparent;color:#17191d;text-align:left}.dcc-tr-history-head b{display:block;font-size:13px}.dcc-tr-history-head small{display:block;margin-top:3px;color:#7b828c;font-size:9px}.dcc-tr-history-body{display:grid;gap:7px;padding:10px;border-top:1px solid rgba(183,123,19,.14)}.dcc-tr-history-day{padding:10px;border:1px solid rgba(183,123,19,.18);border-radius:11px;background:#fffaf1}.dcc-tr-history-ex{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;padding:7px 0;border-top:1px solid rgba(183,123,19,.12);font-size:9px}.dcc-tr-history-ex span:last-child{color:#9a6408;text-align:right}
