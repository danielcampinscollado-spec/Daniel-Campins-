...
(function(){
  ...
  const MALE_VISUAL={Pectoral:'client-pectoral-premium-v5.webp',Dorsal:'client-dorsal-premium-v5.webp',Hombros:'client-hombros-premium-v5.webp',Trapecio:'client-trapecio-female-premium-v1.webp','Bíceps':'client-biceps-premium-v5.webp','Tríceps':'client-triceps-premium-v5.webp',Antebrazos:'client-antebrazos-female-premium-v1.webp',Core:'client-core-premium-v5.webp','Cuádriceps':'client-cuadriceps-premium-v5.webp',Femoral:'client-femoral-premium-v5.webp','Glúteos':'client-gluteos-premium-v5.webp',Gemelos:'client-gemelos-premium-v5.webp'};
  const FEMALE_SPECIAL={Trapecio:'client-trapecio-female-premium-v1.webp',Antebrazos:'client-antebrazos-female-premium-v1.webp'};
  const FEMALE_POS={Pectoral:'0% 5%',Dorsal:'50% 5%',Hombros:'100% 5%','Bíceps':'50% 35%','Tríceps':'100% 35%',Core:'50% 65%','Cuádriceps':'100% 65%',Femoral:'0% 95%','Glúteos':'50% 95%',Gemelos:'100% 95%'};
  function muscleVisual(m){if(state.anatomyDraft==='female'){if(FEMALE_SPECIAL[m])return `background-image:url('./assets/muscles/${FEMALE_SPECIAL[m]}')`;if(['Cuádriceps','Femoral','Glúteos','Gemelos'].includes(m))return `background-image:url('./assets/muscles/client-pierna-completa-female-premium-v1.webp')`;return `background-image:url('./assets/muscles/anatomy-female-premium-v1.webp');background-size:300% 400%;background-position:${FEMALE_POS[m]||'center'}`}return `background-image:url('./assets/muscles/${MALE_VISUAL[m]||'anatomy-male-final.svg'}')`}
