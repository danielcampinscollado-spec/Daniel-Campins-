...
#coach-main .dcc-muscle-anatomy-sub{margin-top:1px!important;font-size:8px!important;color:#777f89!important}
#coach-main .dcc-muscle-anatomy-options{display:grid!important;grid-template-columns:1fr 1fr!important;gap:6px!important;margin-top:5px!important}
#coach-main .dcc-muscle-anatomy-option{position:relative!important;height:50px!important;padding:2px 6px!important;border:1px solid rgba(190,137,30,.34)!important;border-radius:12px!important;background:#fffdf8!important;color:#17191d!important;display:grid!important;grid-template-columns:52px minmax(0,1fr)!important;align-items:center!important;gap:6px!important;text-align:left!important;overflow:hidden!important;box-shadow:none!important}
#coach-main .dcc-muscle-anatomy-option.on{border-color:#d59b28!important;background:#fff5d9!important;box-shadow:inset 0 0 0 1px rgba(213,155,40,.12)!important}
#coach-main .dcc-muscle-anatomy-preview{width:52px!important;height:40px!important;border:0!important;border-radius:0!important;background-repeat:no-repeat!important;background-size:contain!important;background-position:center!important;mix-blend-mode:multiply!important;filter:grayscale(1) contrast(1.03) brightness(1.04)!important}
#coach-main .dcc-muscle-anatomy-preview.male{background-image:url('${NEUTRAL_MALE}')!important}
#coach-main .dcc-muscle-anatomy-preview.female{background-image:url('${NEUTRAL_FEMALE}')!important}
#coach-main .dcc-muscle-anatomy-option b{display:block!important;font-size:10px!important;color:#17191d!important}
#coach-main .dcc-muscle-anatomy-option small{display:block!important;margin-top:1px!important;color:#81858c!important;font-size:7px!important}
#coach-main .dcc-muscle-anatomy-dot{position:absolute!important;right:6px!important;top:6px!important;width:15px!important;height:15px!important;border:1px solid rgba(183,123,19,.48)!important;border-radius:50%!important;background:#fffdf8!important;color:transparent!important;display:grid!important;place-items:center!important;font-size:8px!important;font-weight:900!important}
#coach-main .dcc-muscle-anatomy-option.on .dcc-muscle-anatomy-dot{background:#d5a33d!important;color:#171109!important}
#coach-main .dcc-muscle-anatomy-hint{margin:5px 1px 0!important;font-size:7.5px!important;color:#9a6812!important;font-weight:750!important}
#coach-main .dcc-muscle-premium-grid{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:6px!important;margin-top:5px!important}
#coach-main .dcc-muscle-premium-grid.dcc-await-anatomy{display:none!important}
#coach-main button.dcc-muscle-premium-card{position:relative!important;min-width:0!important;height:62px!important;min-height:62px!important;padding:0!important;border:1px solid #d6a13a!important;border-radius:12px!important;background:#fffaf0!important;color:#17191d!important;box-shadow:0 3px 9px rgba(92,66,24,.04)!important;display:flex!important;flex-direction:column!important;align-items:stretch!important;justify-content:flex-end!important;gap:0!important;overflow:hidden!important}
#coach-main button.dcc-muscle-premium-card.is-selected{border-color:#b9790e!important;box-shadow:0 0 0 2px rgba(213,155,40,.18),0 4px 10px rgba(92,66,24,.07)!important;background:#fff4d5!important}
#coach-main .dcc-muscle-premium-art{width:88px!important;height:43px!important;margin:0 auto!important;flex:none!important;background-repeat:no-repeat!important;background-size:294px 210px!important;border-radius:0!important;mix-blend-mode:multiply!important}
#coach-main .dcc-muscle-premium-name{display:flex!important;align-items:center!important;justify-content:center!important;width:100%!important;min-height:18px!important;padding:2px!important;background:rgba(255,253,248,.92)!important;border-top:1px solid rgba(214,161,58,.14)!important;font-size:8.8px!important;line-height:1!important;font-weight:900!important;color:#17191d!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}
#coach-main .dcc-muscle-premium-check{position:absolute!important;right:5px!important;top:5px!important;min-width:17px!important;height:17px!important;padding:0 4px!important;border:0!important;border-radius:6px!important;background:transparent!important;color:transparent!important;display:grid!important;place-items:center!important;font-size:9px!important;font-weight:900!important;z-index:2!important}
#coach-main button.dcc-muscle-premium-card.is-selected .dcc-muscle-premium-check{background:#b9790e!important;color:#fff!important}
#coach-main .training-muscle-counter{color:#8e6114!important;font-weight:850!important}
#coach-main button.dcc-muscle-premium-card>.training-muscle-check{display:none!important}
...
function sprite(g,a){
  ...
  if(a==='female'&&g==='Trapecio'){
    return `background-image:url("${FEMALE_TRAP}")!important;background-size:cover!important;background-position:center!important`;
  }
  if(a==='female'&&g==='Antebrazos'){
    return `background-image:url("${FEMALE_FOREARMS}")!important;background-size:cover!important;background-position:center!important`;
  }
