...
(function(){
'use strict';
const BUILD='20260917-coach-theme-v38-black-is-black';
...
function currentTheme(){
 ...
 const dataTheme=root.dataset.dccTheme;
 if(dataTheme==='dark'||dataTheme==='light-premium')return dataTheme;
 try{return localStorage.getItem('dcc:theme:v1')==='light-premium'?'light-premium':'dark'}catch(_){return'dark'}
}
function repairThemeClass(){
 const root=document.documentElement,theme=currentTheme();
 root.dataset.dccTheme=theme;
 if(theme==='light-premium')root.classList.add('dcc-theme-light-premium');
 else root.classList.remove('dcc-theme-light-premium');
 return theme;
}
...
/* DCC ORIGINAL / BLACK: el fondo y las superficies del entrenador son realmente negras. */
html[data-dcc-theme="dark"],html[data-dcc-theme="dark"] body,html[data-dcc-theme="dark"] body .app,html[data-dcc-theme="dark"] body #coach,html[data-dcc-theme="dark"] body #coach #coach-main{background:#080a0e!important;background-color:#080a0e!important;background-image:none!important;color:#f4f1e9!important}
html[data-dcc-theme="dark"] body #coach #coach-main h1,html[data-dcc-theme="dark"] body #coach #coach-main h2,html[data-dcc-theme="dark"] body #coach #coach-main h3{color:#f4f1e9!important}
html[data-dcc-theme="dark"] body #coach #coach-main .dcc-cl-head p,html[data-dcc-theme="dark"] body #coach #coach-main .dcc-cl-subtools{color:#8d95a1!important}
html[data-dcc-theme="dark"] body #coach #coach-main .dcc-cl-search,html[data-dcc-theme="dark"] body #coach #coach-main .dcc-fcl-search,html[data-dcc-theme="dark"] body #coach #coach-main .dcc-cl-sort,html[data-dcc-theme="dark"] body #coach #coach-main .dcc-fcl-sort{background:linear-gradient(145deg,#151a21,#0d1116)!important;background-color:#10141a!important;color:#d9dde4!important;border-color:rgba(217,170,74,.38)!important;box-shadow:none!important}
html[data-dcc-theme="dark"] body #coach #coach-main .dcc-cl-search input,html[data-dcc-theme="dark"] body #coach #coach-main .dcc-fcl-search input{background:transparent!important;background-color:transparent!important;color:#f1f3f6!important;-webkit-text-fill-color:#f1f3f6!important;border:0!important;box-shadow:none!important}
html[data-dcc-theme="dark"] body #coach #coach-main .dcc-cl-search input::placeholder,html[data-dcc-theme="dark"] body #coach #coach-main .dcc-fcl-search input::placeholder{color:#777f8c!important;-webkit-text-fill-color:#777f8c!important;opacity:1!important}
html[data-dcc-theme="dark"] body #coach #coach-main .dcc-client-card-authority,html[data-dcc-theme="dark"] body #coach #coach-main .dcc-cl-card,html[data-dcc-theme="dark"] body #coach #coach-main .dcc-fcl-card{background:linear-gradient(145deg,#12171d,#0a0e13)!important;background-color:#0d1116!important;color:#f4f1e9!important;border-color:rgba(217,170,74,.38)!important;box-shadow:0 8px 22px rgba(0,0,0,.18)!important}
html[data-dcc-theme="dark"] body #coach #coach-main .dcc-client-copy-authority strong,html[data-dcc-theme="dark"] body #coach #coach-main .dcc-cl-name,html[data-dcc-theme="dark"] body #coach #coach-main .dcc-fcl-name{color:#f4f1e9!important}
html[data-dcc-theme="dark"] body #coach #coach-main .dcc-client-copy-authority small{color:#8d95a1!important}
html[data-dcc-theme="dark"] body #coach #coach-main .dcc-client-avatar-authority{background:#17170f!important;color:#e8b94f!important;border-color:rgba(217,170,74,.42)!important}
html[data-dcc-theme="dark"] body #coach #coach-main .dcc-client-manage-authority{background:#101319!important;color:#e8b94f!important;border-color:#c9952f!important;box-shadow:none!important}
...
@media(max-width:900px){
 ...
 html[data-dcc-theme="dark"] body #coach#coach #coach-nav#coach-nav{background:linear-gradient(145deg,#171915 0%,#090b09 58%,#15150f 100%)!important;background-color:#0d0f0c!important;background-image:linear-gradient(145deg,#171915 0%,#090b09 58%,#15150f 100%)!important;box-shadow:0 10px 28px rgba(0,0,0,.34)!important}
 html[data-dcc-theme="light-premium"] body #coach#coach #coach-nav#coach-nav{background:#fffdf9!important;background-color:#fffdf9!important;background-image:none!important;box-shadow:0 10px 28px rgba(93,67,25,.12)!important}
 ...
 html[data-dcc-theme="dark"] body #coach#coach #coach-nav#coach-nav button{color:#a0a5ad!important;-webkit-text-fill-color:#a0a5ad!important}
 html[data-dcc-theme="light-premium"] body #coach#coach #coach-nav#coach-nav button{color:#666b73!important;-webkit-text-fill-color:#666b73!important}
...
function clearThemeInline(el){if(!el)return;['background','background-color','background-image','color','-webkit-text-fill-color','border','box-shadow','filter','transform'].forEach(p=>el.style.removeProperty(p))}
function stabilize(){
 installStyles();repairThemeClass();
 if(!matchMedia('(max-width:900px)').matches)return;
 const side=document.querySelector('#coach > .side'),nav=document.getElementById('coach-nav');if(!side||!nav)return;
 ...
 nav.querySelectorAll('button').forEach(b=>{clearThemeInline(b);b.querySelectorAll('svg,span').forEach(x=>{x.style.removeProperty('color');x.style.removeProperty('-webkit-text-fill-color');x.style.removeProperty('transform')})});
}
installStyles();
