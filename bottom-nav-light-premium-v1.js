/* DCC — barra inferior blanca/dorada: autoridad persistente tras cada reconstrucción del nav */
(function(){
'use strict';
const BUILD='20260916-bottom-nav-white-gold-v7-persistent';
...
@media(max-width:900px){
  ...
  body #coach .side #coach-nav button,body #client .side #client-nav button{
    ...
    transform:none!important;animation:none!important;box-sizing:border-box!important;
  }
  ...
  body #coach .side #coach-nav button svg,body #client .side #client-nav button svg{width:21px!important;height:21px!important;color:#a66d0b!important;stroke:currentColor!important;filter:none!important}
  body #coach .side #coach-nav button.active svg,body #client .side #client-nav button.active svg{color:#17140d!important}
  body #coach .side #coach-nav button span,body #client .side #client-nav button span{color:#a66d0b!important;font-size:8px!important;line-height:1!important;font-weight:700!important;margin-top:2px!important;text-shadow:none!important}
...
let queued=false;
function schedule(){if(queued)return;queued=true;requestAnimationFrame(()=>{queued=false;forceWhiteNav()})}
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',schedule,{once:true});else schedule();
// buildCoachNav/buildClientNav reemplazan el contenido después de cargar; vigilamos sólo cambios de nodos.
// No observamos atributos, así que aplicar estilos inline no puede crear un bucle ni vibración.
