...
(function(){
  ...
  function loadOnce(src,key){
    ...
    const s=document.createElement('script');s.src=src;s.async=false;s.dataset[key]='1';
  ...
  function loadPersistenceFixes(){
    ...
    loadOnce('./client-access-coach-v1.js?v=20260913-2300','dccClientAccessCoachV2');
    loadOnce('./routine-authority-v1.js?v=20260914-routine-v6','dccRoutineAuthorityDirect');
    loadOnce('./training-progress-authority-v1.js?v=20260913-2315','dccTrainingProgressAuthorityV3');
  ...
  function refresh(){
    ...
    requestAnimationFrame(()=>{queued=false;installCss();markRoutineHistory();loadPersistenceFixes()});
  }
  ...
  function bindCoachRefresh(){
    ...
    const refreshClientAdmin=()=>{if(main.classList.contains('dcc-ca'))requestAnimationFrame(refresh)};
