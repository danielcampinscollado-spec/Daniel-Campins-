...
function mealHtml(meal,index){
  ...
  return `<section class="pdf-meal"><div class="pdf-meal-head"><h2>${esc(meal?.name||('Comida '+(index+1)))}</h2></div><div class="pdf-meal-body">${body}</div></section>`;
}
...
window.dccPrintClientDiet=function(){
  ...
  *{box-sizing:border-box}html,body{margin:0;background:#f4eee3;color:#1b1e24;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif;-webkit-print-color-adjust:exact;print-color-adjust:exact}
  body{padding:16px}.sheet{max-width:860px;margin:0 auto;background:#fffdf8;padding:24px;border:1px solid #ead9b8;box-shadow:0 18px 52px rgba(70,50,18,.09)}
  .brand{text-align:center;margin-bottom:14px}.brand-kicker{color:#a87318;font-size:8px;font-weight:900;letter-spacing:2.7px;text-transform:uppercase}.brand h1{margin:6px 0 2px;font-family:Georgia,"Times New Roman",serif;font-size:29px;line-height:1.02;font-weight:600}.brand p{margin:0;color:#6e7784;font-size:8px;letter-spacing:2.6px;text-transform:uppercase}
  .meta{display:grid;grid-template-columns:1.35fr .65fr;border:1px solid #ead9b8;border-radius:12px;overflow:hidden;margin:0 0 10px}.meta div{padding:8px 11px;border-right:1px solid #ead9b8}.meta div:last-child{border-right:0}.meta small{display:block;color:#808794;font-size:7.5px}.meta b{display:block;margin-top:2px;font-size:10px}
  ...
  .meals{display:grid;gap:7px}.pdf-meal{display:grid;grid-template-columns:168px 1fr;border:1px solid #ead9b8;border-radius:12px;overflow:hidden;break-inside:avoid}.pdf-meal-head{display:flex;align-items:center;padding:9px 12px;background:#fffaf0;border-right:1px solid #ead9b8}.pdf-meal h2{margin:0;font-family:Georgia,"Times New Roman",serif;font-size:16px;line-height:1.05;font-weight:600}.pdf-meal-body{padding:8px 11px}.pdf-option+.pdf-option{margin-top:9px;padding-top:8px;border-top:1px dashed #ead9b8}.pdf-option-title{margin-bottom:5px;color:#9a660a;font-size:8px;font-weight:900;text-transform:uppercase;letter-spacing:1.3px}.pdf-food{display:grid;grid-template-columns:1fr auto;gap:12px;padding:1.5px 0;font-size:9px;line-height:1.3}.pdf-food span:before{content:'•';margin-right:7px;color:#c48a1e}.pdf-food b{font-weight:650;color:#46505e}.pdf-empty{color:#8c929a;font-size:9px}
  ...
  @media print{body{padding:0;background:#fff}.sheet{max-width:none;border:0;box-shadow:none;padding:0}.printbar{display:none}.pdf-meal{grid-template-columns:155px 1fr}.brand h1{font-size:28px}}
  @media(max-width:720px){body{padding:8px}.sheet{padding:14px}.brand{margin-bottom:11px}.brand h1{font-size:25px}.brand-kicker{font-size:7px;letter-spacing:2.2px}.brand p{font-size:7px;letter-spacing:2.1px}.meta{grid-template-columns:1.35fr .65fr}.meta div{padding:7px 8px;border-right:1px solid #ead9b8;border-bottom:0}.meta small{font-size:6.5px}.meta b{font-size:8.5px}.pdf-meal{grid-template-columns:126px 1fr}.pdf-meal-head{padding:8px 10px;border-right:1px solid #ead9b8;border-bottom:0}.pdf-meal h2{font-size:13.5px}.pdf-meal-body{padding:7px 9px}.pdf-food{font-size:8.5px;gap:8px}}
  ...
  <section class="meta"><div><small>Cliente</small><b>${esc(c.name||'Cliente')}</b></div><div><small>Fecha</small><b>${esc(date)}</b></div></section>
