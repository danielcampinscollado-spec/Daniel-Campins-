...
window.dccPrintClientDiet=function(){
  ...
  *{box-sizing:border-box}html,body{margin:0;background:#f4eee3;color:#1b1e24;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Arial,sans-serif;-webkit-print-color-adjust:exact;print-color-adjust:exact}
  ...
  @media(max-width:720px){body{padding:8px}.sheet{padding:14px}.brand{margin-bottom:11px}.brand h1{font-size:25px}.brand-kicker{font-size:7px;letter-spacing:2.2px}.brand p{font-size:7px;letter-spacing:2.1px}.meta{grid-template-columns:1.15fr 1.05fr .8fr}.meta div{padding:7px 8px;border-right:1px solid #ead9b8;border-bottom:0}.meta small{font-size:6.5px}.meta b{font-size:8.5px}.pdf-meal{grid-template-columns:126px 1fr}.pdf-meal-head{padding:8px;gap:6px;border-right:1px solid #ead9b8;border-bottom:0}.pdf-num{width:22px;height:22px;font-size:7px}.pdf-meal h2{font-size:13.5px}.pdf-meal-body{padding:7px 9px}.pdf-food{font-size:8.5px;gap:8px}}
