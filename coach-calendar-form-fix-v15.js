/* DCC calendar form fix v15 — corrige Fecha/Hora en Safari móvil */
(function(){
  'use strict';
  if(window.__dccCalendarFormFixV15)return;
  window.__dccCalendarFormFixV15=true;

  const id='dcc-calendar-form-fix-v15-css';
