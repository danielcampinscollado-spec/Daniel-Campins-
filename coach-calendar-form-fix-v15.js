...
(function(){
  'use strict';
  const BUILD='20260916-calendar-form-v22-gym-home';
  ...
  function injectCss(){
    ...
    const s=document.createElement('style');s.id=STYLE_ID;s.textContent=`
      ...
      #${OVERLAY_ID} label{display:block;margin:0 0 14px;color:#25282d!important;font-size:13px;font-weight:750}#${OVERLAY_ID} input,#${OVERLAY_ID} select,#${OVERLAY_ID} textarea{display:block;width:100%;min-width:0;max-width:100%;margin-top:8px;padding:0 14px;border:1px solid rgba(183,123,19,.28)!important;border-radius:15px;background:#fffefa!important;color:#17191d!important;-webkit-text-fill-color:#17191d!important;outline:0;font:600 14px/1.2 inherit;box-shadow:inset 0 1px 0 rgba(255,255,255,.96)!important}#${OVERLAY_ID} select{height:51px;text-align:center;text-align-last:center}#${OVERLAY_ID} textarea{min-height:92px;padding-top:13px;resize:vertical}#${OVERLAY_ID} textarea::placeholder{color:#737c88!important;-webkit-text-fill-color:#737c88!important;opacity:1!important}
      #${OVERLAY_ID} .row{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:11px;width:100%;min-width:0}
      #${OVERLAY_ID} .picker{position:relative;height:51px;margin-top:8px;border:1px solid rgba(183,123,19,.28)!important;border-radius:15px;background:#fffefa!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.96)!important;overflow:hidden}
      ...
      #${OVERLAY_ID} .picker-display{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;padding:0 10px;pointer-events:none;color:#737c88;font-size:14px;font-weight:700;text-align:center}
