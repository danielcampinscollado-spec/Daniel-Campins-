...
(function(){
  ...
  function injectCss(){
    ...
    s.textContent=`
      ...
      .dcc-cm-empty{padding:28px 15px;border:1px solid rgba(183,123,19,.24);border-radius:19px;background:linear-gradient(145deg,#fffefa,#fbf5eb);color:#707782;text-align:center;font-size:11px;box-shadow:0 10px 26px rgba(78,58,28,.06)}
