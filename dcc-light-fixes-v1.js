/* DCC — Theme final polish V5: paridad real Light/Dark + Apariencia solo Inicio */
(function(){
'use strict';
if(window.__dccThemeFinalFixV5)return;window.__dccThemeFinalFixV5=true;
const STYLE_ID='dcc-theme-final-fix-v5';
function install(){
 document.getElementById('dcc-theme-final-fix-v4')?.remove();
...
/* Apariencia: oculta salvo Inicio real */
...
/* Encabezados oscuros = misma jerarquía que Light */
...
/* Alimentación oscura: misma tipografía sans premium del Light */
...
/* PORTADA ENTRENAMIENTO OSCURA — replica proporciones del Light */
...
/* Hero ejercicios oscuro — mismo disco y misma composición que Light */
...
html:not(.dcc-theme-light-premium) body #client-main .dcc-training-stable-v3 .dct3-routine::before{content:''!important;position:absolute!important;inset:0!important;z-index:0!important;pointer-events:none!important;background:linear-gradient(90deg,rgba(0,0,0,0) 0%,rgba(0,0,0,0) 56%,rgba(0,0,0,.05) 100%)!important}
...
html:not(.dcc-theme-light-premium) body #client-main .dcc-training-stable-v3 .dct3-routine .dct3-meta{color:#959eaa!important;font-family:-apple-system,BlinkMacSystemFont,"SF Pro Text","Segoe UI",Arial,sans-serif!important;font-size:10px!important;max-width:58%!important;margin-top:5px!important}
...
/* Activo oscuro: ilustración contenida igual que Light */
