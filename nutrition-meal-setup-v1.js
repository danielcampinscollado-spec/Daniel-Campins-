...
(function(){
  ...
  const MEALS=['Desayuno','Merienda de mañana','Comida','Merienda de tarde','Cena'];
  let chosenCount=0;
  let selected=[];
  let currentId=null;
  let baseBlank=null;
  ...
  function injectCss(){
    ...
    s.textContent=`
      ...
      #coach-main .dcc-meal-counts{display:grid;grid-template-columns:repeat(5,1fr);gap:7px;margin-top:13px}
