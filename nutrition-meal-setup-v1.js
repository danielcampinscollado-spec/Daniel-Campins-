...
(function(){
  ...
  document.addEventListener('click',e=>{const b=e.target?.closest?.('[data-dcc-meal-choice]');if(!b)return;e.preventDefault();e.stopPropagation();window.dccMealSetupDirectToggle(b.getAttribute('data-dcc-meal-choice')||'')},true);
