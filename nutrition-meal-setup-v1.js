...
(function(){
  ...
  document.addEventListener('click',function(e){const b=e.target.closest&&e.target.closest('#coach-main .dcc-meal-option[data-dcc-meal]');if(!b)return;e.preventDefault();e.stopPropagation();window.dccMealSetupDirectToggle(b.getAttribute('data-dcc-meal')||'')},true);
